...
urlpatterns = [
    ...
    path('news/<int:pk>/edit/', views.NewsEntryUpdateView.as_view(), name='news-entry-update'),
    path('news/<int:pk>/delete/', views.NewsEntryDeleteView.as_view(), name='news-entry-delete'),
]
